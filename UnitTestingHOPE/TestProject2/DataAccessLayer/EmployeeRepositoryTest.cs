...
using UnitTestingHOPE.Tests.DataAccessLayer.Mocks;
using System;
...
namespace UnitTestingHOPE.Tests.DataAccessLayer
{
    public class EmployeeRepositoryTest
    {
        ...
        public void GetEmployees()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(lstData.Count, Is.LessThanOrEqualTo(0)); // Intentional failure
            });
        }
